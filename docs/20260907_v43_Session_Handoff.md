# docs/20260907_v43_Session_Handoff.md — paste this as the first message of the new chat
...
4. Read in full: `docs/PROJECT_STATUS.md` v1.22, this handoff,
...
**THE FIRST TASK IS THE GATE F2 SCOPE MESSAGE (stated priorities).**
Scope -> operator "go" -> build; do not code before the go. F2 needs
network and a quiet SEC window; the fetch pool is now ENABLED
(fetch-probe 200/200 ok, 0 backoffs, 4.1/s observed, run
20260907T171738), so F2's collection runs parallel within SEC's limit.
