...
before L3's review queue produces the first corrections. Next gate: 1.5b (SEC EDGAR full-text miner with FDA Tracker discovery and recall benchmark).
