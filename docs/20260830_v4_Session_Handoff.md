docs/20260830_v4_Session_Handoff.md
...
0a. docs/20260830_v2_Ontology_and_Matching_Design.md — Model 1 design under review (v2 adds the shared Regulatory-event extension, §3.6).
0b. docs/20260830_v1_FDA_Catalyst_Research.md — Model 2 research synthesis; basis for the FDA Catalyst Product Design document (next deliverable).
...
```
git -C "C:\Users\JB\Documents\dev\bioindustry" log --oneline -15
# expected, newest first:
#   <hash>  Docs: handoff v4, PROJECT_STATUS v0.83, README, ontology v2 (FDA research linked)
...
3a. **Review the FDA Catalyst Research note**; on approval the assistant writes `docs/20260830_v1_FDA_Catalyst_Product_Design.md` (requirements: event schema, forward-calendar builder, models M2.1–M2.7 under the shared framework, rule engine, daily run and report, evaluation ledger).
