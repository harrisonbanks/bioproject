# docs/20260902_v2_GATEL3_INSTALL.md
...
## Exit evidence (recorded 2026-09-02, files gatel3_a2/b/c/d5.txt)
pytest 165 at close. Analyser versions: v002 (party-scoped single-read captures), v003 (rule L3-a2: par-value guard, conflict-hold, extended outside date, announce/stake/EV rules, global rationale seq, per-rule finditer), v004 (verdict-gated consume, rationale statement dedup).
Yardstick TEM-PSNL: 34 proposals, 34 span-verified; raw precision 20/32 = 0.625 [0.453, 0.771]; consumed 8 verdict-gated rows (price and consideration conflicts resolved by verdict; exact fee 76,806,179 and outside_date_extended 2028-04-20 are analyser finds absent from the seed); dossier now 12 terms / 2 timeline / 5 rationale; seed rows untouched; consume idempotent.
Batch probe: ten never-seen deals, ~100 documents, 0 fetch failures, 100% span verification; five-deal spot-check (74 proposals): 26 correct / 31 wrong / 17 unsure = 0.456 raw. Accuracy concentrates in deal 8-Ks/proxies; noise in 10-K risk boilerplate. Combined L3-a2 stored-verdict precision 46/89 = 0.517.
a3 agenda (documented, not built): doc-type guards for rationale and price rules; two-tier and reverse termination-fee fields; termination-floor rule; price context guard; ticker-less deal_id naming for harvest rows without FilerTicker.
