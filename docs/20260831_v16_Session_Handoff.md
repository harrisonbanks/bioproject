docs/20260831_v16_Session_Handoff.md

# Session handoff v16 — bioproject, 2026-08-31 (Phase 0 complete; snapshot of record decided; dossier track designed and sequenced; next: gate L1 scope message)

Supersedes docs/20260831_v15_Session_Handoff.md. Structure per J. Banks's
...
#   <hash>  Decision 2026-08-31: sequencing L1 -> 1.4 -> L2 -> 1.5 -> L3 -> L4; P19 Evidence (Design Principles v5, plan v10, PROJECT_STATUS 0.97, handoff v16, README)
