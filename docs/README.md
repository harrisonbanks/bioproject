...
diagrams: current state `docs/20260831_v2_System_Diagram.md`, target state `docs/20260831_v2_System_Diagram_TARGET_STATE.md`; plan and gate ledger: `docs/20260831_v15_Implementation_Plan.md`.
...
src/biointel/           package; run as  python -m biointel <command>
  interfaces/cli.py     63 commands (python -m biointel prints the list)
...
python -m biointel dossier-seed         # L2: span-verified seed dossier (needs the library captures)
