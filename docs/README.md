...
diagrams: current state `docs/20260831_v2_System_Diagram.md`, target state `docs/20260831_v2_System_Diagram_TARGET_STATE.md`; plan and gate ledger: `docs/20260901_v18_Implementation_Plan.md`.
