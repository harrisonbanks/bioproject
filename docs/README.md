...
diagrams: current state `docs/20260829_v1_System_Diagram.png`, target state `docs/20260830_v1_System_Diagram_TARGET_STATE.png`; plan and gate ledger: `docs/20260830_v5_Implementation_Plan.md`.
...
src/biointel/           package; run as  python -m biointel <command>
  interfaces/cli.py     57 commands (python -m biointel prints the list)
