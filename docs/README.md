...
`docs/20260830_v3_Design_Principles.md`; state: `docs/PROJECT_STATUS.md`;
diagrams: current state `docs/20260829_v1_System_Diagram.png`, target state `docs/20260830_v1_System_Diagram_TARGET_STATE.png`; plan and gate ledger: `docs/20260830_v4_Implementation_Plan.md`.
