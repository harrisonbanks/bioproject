docs/20260903_v25_Implementation_Plan.md

# Implementation plan and gate ledger

Bioindustry Intelligence Platform · v25 · 2026-09-03 (v25: ledger rows added for the store extension, the expert-hypothesis store, the constants annotation pass, the raw-SQL guard, the cancelled references rename, and the scoped threshold-reconciliation and F2 gates; fingerprint proofs for L4-P / store extension / annotation pass are owed together at F1 close. Prior header: v24 · 2026-09-03 (v24: gate L4-P DONE —
...
| F1 | equity stakes from 13D/13G | 69bca93 | roadmap §F1 | rows at scale; precision at F1-r6; stubs by approval; fingerprints | IN PROGRESS (collector ~50%; parser r6 coverage 0.992; WIP commits fea4bfd…5e92aa3) |
