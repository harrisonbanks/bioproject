...
def main(path):
    ...
    for r in range(2, co.max_row + 1):
        ...
        companies.append({
            "IID": iid, "Name": co.cell(row=r, column=2).value,
            ...
            "CIK": "", "SIC": "", "SICDescription": "",
            "Exchange": "", "StateOfIncorporation": "",
        })
    ...
    for r in range(2, em.max_row + 1):
        ...
        events.append({
            "IID": iid, "Name": em.cell(row=r, column=2).value,
    ...
    for path_, cols, rows in ((config.COMPANIES_CSV, COMPANY_COLS, companies),
